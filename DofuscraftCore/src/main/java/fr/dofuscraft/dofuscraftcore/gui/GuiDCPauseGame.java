...
public class GuiDCPauseGame extends GuiScreen {

    private static final GuiDCPauseGame INSTANCE = new GuiDCPauseGame();

    private int saveStep;
    private int visibleTime;

    public GuiDCPauseGame()
    {
    }
    ...
    public void showInGameModOptions(GuiDCPauseGame guiIngameMenu)
    {
        Minecraft.getMinecraft().displayGuiScreen(new GuiModList(guiIngameMenu));
    }



    public static GuiDCPauseGame instance()
    {
        return INSTANCE;
    }
