...
public class GuiButtonDCWebsite extends GuiButton
{
	...
	private static final ResourceLocation WEBSITE_HOVER_ICON = new ResourceLocation(References.MODID, "textures/gui/buttons/website_hover.png");

	public GuiButtonDCWebsite(int buttonId, int x, int y)
	{
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
	{
		if( this.visible )
		{
			...
			{
				mc.getTextureManager().bindTexture(WEBSITE_HOVER_ICON);
			}
			else
			{
