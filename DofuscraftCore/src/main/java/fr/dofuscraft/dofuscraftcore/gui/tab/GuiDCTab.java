package fr.dofuscraft.dofuscraftcore.gui.tab;
...
public class GuiDCTab extends GuiButtonToggle
{
    ...
    public GuiDCTab(int p_i47588_1_, ItemStack p_i47588_2_)
    {
        super(p_i47588_1_, 0, 0, 35, 27, false);
        this.category = p_i47588_2_;
        this.initTextureValues(153, 2, 35, 0, this.RECIPE_BOOK);
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        if (this.visible)
        {
            ...
            mc.getRenderItem().renderItemAndEffectIntoGUI(category, this.x + 9, this.y + 5);
