...
public class GuiDCInventory extends InventoryEffectRenderer implements IRecipeShownListener
{
    ...
    private GuiButtonImage playerInfoButton, classInfoButton;
    private final GuiRecipeBook recipeBookGui = new GuiRecipeBook();
    private boolean widthTooNarrow;
    private boolean buttonClicked;

    public GuiDCInventory(EntityPlayer player)
    {
    ...
    public void initGui()
    {
        ...
        this.playerInfoButton = new GuiButtonImage(80, this.guiLeft - 25, this.guiTop + 5, 20, 18, 0, 62, 19, ICONS);
        this.classInfoButton = new GuiButtonImage(100, this.guiLeft - 25, this.guiTop + 27, 20, 18, 21, 62, 19, ICONS);
        //this.buttonList.add(this.recipeButton);
        this.buttonList.add(this.playerInfoButton);
        this.buttonList.add(this.classInfoButton);
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 80){
            ...
            if(playerCap.getID() != ""){
                ...
                this.mc.displayGuiScreen(new GuiDCClasseHelp(playerCap.getID() + ".json"));
